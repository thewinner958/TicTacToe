...
public record GameDto(Integer id, PlayerDto player1, PlayerDto player2, GameSetupDto gameSetup, @JsonProperty(access = JsonProperty.Access.READ_ONLY) Instant created,
                      @JsonProperty(access = JsonProperty.Access.READ_ONLY) Boolean gameStatus, @JsonIgnore String state, @JsonProperty(access = JsonProperty.Access.READ_ONLY) Integer whoWon) implements Serializable {
}